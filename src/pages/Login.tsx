...
const ALLOWED_EMAILS = [
  'robmarq47@mrqzremodeling.com',
  'creandolasoluciones@gmail.com',
  'sebasgarciia288@gmail.com',
  'robmarq47@gmail.com'
];
      ...
      await supabase.auth.signInWithOAuth({
        ...
        options: {
          ...
          queryParams: {
            ...
            hd: 'mrqzremodeling.com,gmail.com'
          },
        },
      });
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Inicia sesión con tu cuenta autorizada</p>
        </div>
